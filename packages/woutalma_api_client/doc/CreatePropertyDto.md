# woutalma_api_client.model.CreatePropertyDto
...
**kind** | **String** |  | 
**transaction** | **String** |  | 
**title** | **String** | Trimmed, and runs of whitespace collapsed to one space, before storage. Accents and non-Latin scripts are preserved. Must not be empty once trimmed. | 
...
**price** | **num** | CFA francs, integer. At least 1 — a free listing is not a product feature — and at most 10000000000. | 
...
**latitude** | **num** |  | 
**longitude** | **num** |  | 
**neighbourhood** | **String** | Quartier name. The client offers a picker of known Dakar quartiers, but any non-empty name is accepted — the list is not exhaustive. Trimmed and whitespace-collapsed before storage. | 
