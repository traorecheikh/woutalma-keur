...
class ReviewsApi {
  ...
  Future<Response<BuiltList<ReviewDto>>> reviewsControllerAll({
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<ReviewDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ReviewDto>>> reviewsControllerByBroker({
    ...
    final _path = r'/reviews/broker/{brokerId}'.replaceAll(
        '{' r'brokerId' '}',
        encodeQueryParameter(_serializers, brokerId, const FullType(String))
            .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
    ...
    final _queryParameters = <String, dynamic>{
      if (onlyPublic != null)
        r'onlyPublic': encodeQueryParameter(
            _serializers, onlyPublic, const FullType(bool)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [ReviewDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReviewDto>> reviewsControllerReply({
    required String id,
    required ReplyReviewDto replyReviewDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/reviews/{id}/reply'.replaceAll(
        '{' r'id' '}',
    ...
    try {
      const _type = FullType(ReplyReviewDto);
      _bodyData = _serializers.serialize(replyReviewDto, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [ReviewDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ReviewDto>> reviewsControllerReport({
    required String id,
    required ReportReviewDto reportReviewDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/reviews/{id}/report'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      const _type = FullType(ReportReviewDto);
      _bodyData = _serializers.serialize(reportReviewDto, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
